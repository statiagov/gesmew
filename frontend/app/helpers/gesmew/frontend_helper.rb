module Gesmew
  module FrontendHelper
    ...
    def link_to_cart(text = nil)
      text = text ? h(text) : Gesmew.t('cart')
      css_class = nil

      if simple_current_order.nil? or simple_current_order.item_count.zero?
        text = "<span class='glyphicon glyphicon-shopping-cart'></span> #{text}: (#{Gesmew.t('empty')})"
        css_class = 'empty'
      else
      ...
      link_to text.html_safe, gesmew.cart_path, :class => "cart-info #{css_class}"
    end
