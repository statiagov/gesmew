...
describe "Coupon code promotions", type: :feature, js: true do
  ...
  context "visitor makes checkout as guest without registration" do
    def create_basic_coupon_promotion(code)
      promotion = Gesmew::Promotion.create!(name:       code.titleize,
                                           code:       code,
                                           starts_at:  1.day.ago,
                                           expires_at: 1.day.from_now)

      calculator = Gesmew::Calculator::FlatRate.new
      calculator.preferred_amount = 10

      action = Gesmew::Promotion::Actions::CreateItemAdjustments.new
    ...
    context "on the payment page" do
      before do
        ...
        fill_in "order_email", with: "gesmew@example.com"
      ...
      it "informs the user about a coupon code which has exceeded its usage" do
        ...
        click_button "Save and Continue"
        expect(page).to have_content(Gesmew.t(:coupon_code_max_usage))
      end
