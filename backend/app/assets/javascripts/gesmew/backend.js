...
Gesmew.routes.orders_api = Gesmew.pathFor('api/v1/inspections')
Gesmew.routes.products_api = Gesmew.pathFor('api/v1/establishments')
Gesmew.routes.product_search = Gesmew.pathFor('admin/search/establishments')
...
Gesmew.routes.edit_product = function(product_id) {
  return Gesmew.pathFor('admin/establishments/' + product_id + '/edit')
}

Gesmew.routes.payments_api = function(order_id) {
  return Gesmew.pathFor('api/v1/inspections/' + order_id + '/payments')
}
