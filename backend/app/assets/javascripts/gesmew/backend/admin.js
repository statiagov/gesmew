...
under the gesmew namespace that do stuff we find helpful.
...
handle_date_picker_fields = function(){
  $('.datepicker').datepicker({
    dateFormat: Gesmew.translations.date_picker,
    dayNames: Gesmew.translations.abbr_day_names,
    dayNamesMin: Gesmew.translations.abbr_day_names,
    firstDay: Gesmew.translations.first_day,
    monthNames: Gesmew.translations.month_names,
    prevText: Gesmew.translations.previous,
    nextText: Gesmew.translations.next,
    showOn: "focus"
  });
...
$(document).ready(function(){
  ...
  var uniqueId = 1;
  $('.gesmew_add_fields').click(function() {
  ...
  $('body').on('click', 'a.gesmew_remove_fields', function() {
    el = $(this);
