  ...
  module Admin
    class ReturnAuthorizationsController < ResourceController
      ...
      def fire
        ...
        flash[:success] = Gesmew.t(:return_authorization_updated)
        redirect_to :back
      end
      ...
      def load_return_items
        ...
        new_return_items = unassociated_inventory_units.map do |new_unit|
          Gesmew::ReturnItem.new(inventory_unit: new_unit).tap(&:set_default_pre_tax_amount)
        end
      ...
      def load_return_authorization_reasons
        @reasons = Gesmew::ReturnAuthorizationReason.active
