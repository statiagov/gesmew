  ...
  module Admin
    class ProductsController < ResourceController
      ...
      def destroy
        ...
        flash[:success] = Gesmew.t('notice_messages.product_deleted')
      ...
      def clone
        ...
        if @new.save
          flash[:success] = Gesmew.t('notice_messages.product_cloned')
        else
          flash[:error] = Gesmew.t('notice_messages.product_not_cloned')
        end
      ...
      def location_after_save
        gesmew.edit_admin_product_url(@product)
      end
      ...
      def collection
        ...
        @collection = @search.result.
              ...
              page(params[:page]).
              per(params[:per_page] || Gesmew::Config[:admin_products_per_page])
        @collection
      end

      def create_before
        return if params[:product][:prototype_id].blank?
        @prototype = Gesmew::Prototype.find(params[:product][:prototype_id])
      end
