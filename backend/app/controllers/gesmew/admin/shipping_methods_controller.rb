  ...
  module Admin
    class ShippingMethodsController < ResourceController
      ...
      def set_shipping_category
        ...
        @shipping_method.shipping_categories = Gesmew::ShippingCategory.where(:id => params["shipping_method"][:shipping_categories])
      ...
      def set_zones
        ...
        @shipping_method.zones = Gesmew::Zone.where(:id => params["shipping_method"][:zones])
        @shipping_method.save
      ...
      def load_data
        ...
        @tax_categories = Gesmew::TaxCategory.order(:name)
