...
module Gesmew
  module Admin
    class WidgetsController < Gesmew::Admin::ResourceController
...
describe Gesmew::Admin::WidgetsController, :type => :controller do
  stub_authorization!

  after(:all) do
    # Gesmew::Core::Engine.routes.reload_routes!
  ...
  before do
    ...
    stub_const('Gesmew::Widget', Widget)
  end
  ...
  describe '#edit' do
    ...
    subject do
      gesmew_get :edit, id: widget.to_param
    end
  ...
  describe '#create' do
    ...
    subject { gesmew_post :create, params }
  ...
  describe '#update' do
    ...
    subject { gesmew_put :update, params }
  ...
  describe '#update_positions' do
    ...
    subject do
      gesmew_post :update_positions, id: widget_1.to_param,
...
module Gesmew
  module Submodule
    class Post < Gesmew::Base
    end
  end
  module Admin
    module Submodule
      class PostsController < Gesmew::Admin::ResourceController
        prepend_view_path('spec/test_views')

        def model_class
          Gesmew::Submodule::Post
        end
      end
    end
  end
...
describe Gesmew::Admin::Submodule::PostsController, type: :controller do
  stub_authorization!
  ...
  describe '#edit' do
    let(:submodule_post) { Gesmew::Submodule::Post.create!(name: 'a post') }

    subject do
      gesmew_get :edit, id: submodule_post.to_param
    end
  ...
  describe '#create' do
    ...
    it 'creates the resource' do
      expect { subject }.to change { Gesmew::Submodule::Post.count }.by(1)
    end
  end

  describe '#update' do
    let(:post) { Gesmew::Submodule::Post.create!(name: 'a post') }
  ...
  describe '#destroy' do
    ...
    subject { gesmew_delete :destroy, params }

    it 'destroys the resource' do
      expect { subject }.to change { Gesmew::Submodule::Post.count }.from(1).to(0)
    end
  end
end
