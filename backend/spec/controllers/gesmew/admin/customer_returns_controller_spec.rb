  ...
  module Admin
    describe CustomerReturnsController, :type => :controller do
      ...
      describe "#index" do
        ...
        subject do
          gesmew_get :index, { order_id: customer_return.order.to_param }
        end
      ...
      describe "#edit" do
        ...
        subject do
          gesmew_get :edit, { order_id: order.to_param, id: customer_return.to_param }
        end
      ...
      describe "#create" do
        ...
        subject do
          gesmew_post :create, customer_return_params
        end
        ...
        context "valid customer return" do
          ...
          it "creates a customer return" do
            expect{ subject }.to change { Gesmew::CustomerReturn.count }.by(1)
          end

          it "redirects to the index page" do
            subject
            expect(response).to redirect_to(gesmew.edit_admin_order_customer_return_path(order, assigns(:customer_return)))
          end
        end
        ...
        context "invalid customer return" do
          ...
          it "doesn't create a customer return" do
            expect{ subject }.to_not change { Gesmew::CustomerReturn.count }
          end
