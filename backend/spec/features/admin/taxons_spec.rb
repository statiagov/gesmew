...
feature "Taxonomies and taxons" do
  ...
  scenario "admin should be able to edit taxon" do
    visit gesmew.new_admin_taxonomy_path

    fill_in "Name", with: "Hello"
    click_button "Create"

    @taxonomy = Gesmew::Taxonomy.last

    visit gesmew.edit_admin_taxonomy_taxon_path(@taxonomy, @taxonomy.root.id)
  ...
  scenario "admin should be able to remove a product from a taxon", js: true do
    ...
    visit gesmew.admin_taxons_path
