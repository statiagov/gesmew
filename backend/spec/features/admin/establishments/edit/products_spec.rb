...
describe 'Establishment Details', type: :feature, js: true do
  stub_authorization!

  context 'editing a establishment' do
    it 'should list the establishment details' do
      create(:establishment, :name => 'Bún thịt nướng', :sku => 'A100',
  ...
  context "deleting a establishment" do
