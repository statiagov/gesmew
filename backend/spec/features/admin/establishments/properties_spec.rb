...
describe "Properties", type: :feature, js: true do
  ...
  context "Property index" do
    ...
    context "listing establishment properties" do
      it "should list the existing establishment properties" do
        within_row(1) do
  ...
  context "creating a property" do
    it "should allow an admin to create a new establishment property", js: true do
      click_link "Products"
      click_link "Properties"
  ...
  context "editing a property" do
    ...
    it "should allow an admin to edit an existing establishment property" do
  ...
  context "linking a property to a establishment" do
    before do
    ...
    it "successfully create and then remove establishment property" do
      fill_in_property
    ...
    it "successfully remove and create a establishment property at the same time" do
      fill_in_property
      ...
      expect(page).not_to have_content("Establishment is not found")
