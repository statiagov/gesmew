# This is the primary location for defining gesmew preferences
#
# The expectation is that this is created once and stored in
# the gesmew environment
#
# setters:
# a.color = :blue
# a[:color] = :blue
...
# a.preferred_color
#
require "gesmew/core/search/base"
...
module Gesmew
  class AppConfiguration < Preferences::Configuration
    ...
    # searcher_class allows gesmew extension writers to provide their own Search class
    def searcher_class
      @searcher_class ||= Gesmew::Core::Search::Base
    end
