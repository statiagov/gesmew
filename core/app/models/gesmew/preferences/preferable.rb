...
# Examples:
#
#   # Gesmew::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Gesmew::Base
...
#   s.save!
module Gesmew::Preferences::Preferable
  extend ActiveSupport::Concern

  included do
    extend Gesmew::Preferences::PreferableClassMethods
  end
