...
describe Gesmew::Money do
  ...
  context "with currency" do
    it "passed in option" do
      money = Gesmew::Money.new(10, :with_currency => true, :html => false)
  ...
  context "hide cents" do
    it "hides cents suffix" do
      money = Gesmew::Money.new(10, no_cents: true)
  ...
  context "currency parameter" do
    context "when currency is specified in Canadian Dollars" do
      it "uses the currency param over the global configuration" do
        money = Gesmew::Money.new(10, :currency => 'CAD', :with_currency => true, :html => false)
    ...
    context "when currency is specified in Japanese Yen" do
      it "uses the currency param over the global configuration" do
        money = Gesmew::Money.new(100, :currency => 'JPY', :html => false)
  ...
  context "symbol positioning" do
    it "passed in option" do
      money = Gesmew::Money.new(10, :symbol_position => :after, :html => false)
      expect(money.to_s).to eq("10.00 $")
    end
  end
  ...
  context "sign before symbol" do
    ...
    it "passed in option" do
      money = Gesmew::Money.new(-10, :sign_before_symbol => false)
      expect(money.to_s).to eq("$-10.00")
    end
  end
  ...
  context "JPY" do
    ...
    it "formats correctly" do
      money = Gesmew::Money.new(1000, :html => false)
  ...
  context "EUR" do
    ...
    it "formats as plain by default" do
      money = Gesmew::Money.new(10, symbol_position: :after)
      expect(money.to_s).to eq("10.00 €")
    end
    ...
    it "formats as HTML with currency" do
      money = Gesmew::Money.new(10, symbol_position: :after, with_currency: true)
      # The HTML'ified version of "10.00 €"
