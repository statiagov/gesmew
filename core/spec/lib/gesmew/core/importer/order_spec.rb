...
module Gesmew
  module Core
    describe Importer::Order do
      ...
      let(:product) do
        product = Gesmew::Product.create(name: 'Test',
                                        sku: 'TEST-1',
                                        price: 33.22)
      ...
      context "assigning a user to an order" do
        ...
        context "as an admin" do
          before { allow(user).to receive_messages has_gesmew_role?: true }
        ...
        context "as a user" do
          before { allow(user).to receive_messages has_gesmew_role?: false }
