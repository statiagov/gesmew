# require 'spec_helper'
#
# describe Gesmew::BaseHelper, type: :helper do
...
#       before do
#         Gesmew::Config[:checkout_zone] = nil
#       end
#
#       it "return complete list of countries" do
#         expect(available_countries.count).to eq(Gesmew::Country.count)
#       end
#     end
#
...
#           Gesmew::Config[:checkout_zone] = @country_zone.name
#         end
#
...
#           Gesmew::Config[:checkout_zone] = state_zone.name
#         end
#
#         it "return complete list of countries" do
#           expect(available_countries.count).to eq(Gesmew::Country.count)
