        ...
        included do
          ...
          def title
            ...
            if title_string.present?
              if Gesmew::Config[:always_put_site_name_in_title]
          ...
          #
          # You can set the layout you want to render inside your Gesmew configuration with the +:layout+ option.
          #
          # Default layout is: +app/views/gesmew/layouts/gesmew_application+
          #
          def get_layout
            layout ||= Gesmew::Config[:layout]
          end
