...
module Gesmew
  class DummyGenerator < Rails::Generators::Base
    desc "Creates blank Rails application, installs Gesmew and all sample data"
    ...
    def test_dummy_inject_extension_requirements
      if DummyGeneratorHelper.inject_extension_requirements
        inside dummy_path do
          inject_require_for('gesmew_frontend')
          inject_require_for('gesmew_backend')
          inject_require_for('gesmew_api')
        end
      end
    end
...
begin
  ...
  # #{requirement} is not available.
    ...
    def gemfile_path
      core_gems = ["gesmew/core", "gesmew/api", "gesmew/backend", "gesmew/frontend"]
...
module Gesmew::DummyGeneratorHelper
