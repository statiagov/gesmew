...
module Gesmew
  describe Api::V1::ReturnAuthorizationsController, :type => :controller do
    ...
    let!(:inspection) { create(:shipped_order) }
    ...
    context "as an admin" do
      ...
      it "can show return authorization" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
        api_get :show, :order_id => inspection.number, :id => return_authorization.id
      ...
      it "can get a list of return authorizations" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        api_get :index, { :order_id => inspection.number }
        expect(response.status).to eq(200)
      ...
      it 'can control the page size through a parameter' do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        api_get :index, :order_id => inspection.number, :per_page => 1
      ...
      it 'can query the results through a paramter' do
        ...
        inspection.return_authorizations << expected_result
      ...
      it "can learn how to create a new return authorization" do
        ...
        expect(required_attributes).to include("inspection")
      end

      it "can update a return authorization on the inspection" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
      ...
      it "can cancel a return authorization on the inspection" do
        FactoryGirl.create(:new_return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
      ...
      it "can delete a return authorization on the inspection" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
      ...
      it "can add a new return authorization to an existing inspection" do
        ...
        rma_params = { :stock_location_id => stock_location.id,
                       ...
                       :memo => "Defective" }
        api_post :create, :order_id => inspection.number, :return_authorization => rma_params
    ...
    context "as just another user" do
      it "cannot add a return authorization to the inspection" do
        api_post :create, :return_autorization => { :order_id => inspection.number, :memo => "Defective" }
        assert_unauthorized!
      end

      it "cannot update a return authorization on the inspection" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
        api_put :update, :id => return_authorization.id, :return_authorization => { :memo => "ABC" }
        assert_unauthorized!
      ...
      it "cannot delete a return authorization on the inspection" do
        FactoryGirl.create(:return_authorization, :inspection => inspection)
        return_authorization = inspection.return_authorizations.first
        api_delete :destroy, :id => return_authorization.id
        assert_unauthorized!
