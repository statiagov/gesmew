      ...
      context "for a given payment" do
        ...
        context "authorizing" do
          ...
          context "authorization fails" do
            before do
              ...
              expect_any_instance_of(Gesmew::Gateway::Bogus).to receive(:authorize).and_return(fake_response)
              api_put :authorize, :id => payment.to_param
            end
        ...
        context "capturing" do
          ...
          context "capturing fails" do
            before do
              ...
              expect_any_instance_of(Gesmew::Gateway::Bogus).to receive(:capture).and_return(fake_response)
            end
        ...
        context "purchasing" do
          ...
          context "purchasing fails" do
            before do
              fake_response = double(:success? => false, :to_s => "Insufficient funds")
              expect_any_instance_of(Gesmew::Gateway::Bogus).to receive(:purchase).and_return(fake_response)
            end
        ...
        context "voiding" do
          ...
          context "voiding fails" do
            before do
              ...
              expect_any_instance_of(Gesmew::Gateway::Bogus).to receive(:void).and_return(fake_response)
            end
