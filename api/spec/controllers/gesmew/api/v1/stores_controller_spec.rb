...
module Gesmew
  describe Api::V1::StoresController, type: :controller do
    ...
    let!(:store) do
      create(:store, name: "My Gesmew Store", url: "gesmewstore.example.com")
    end
    ...
    context "as an admin" do
      ...
      it "I can list the available stores" do
        ...
        expect(json_response["stores"]).to eq([
          {
            "id" => store.id,
            "name" => "My Gesmew Store",
            "url" => "gesmewstore.example.com",
            "meta_description" => nil,
            "meta_keywords" => nil,
            "seo_title" => nil,
            "mail_from_address" => "gesmew@example.org",
      ...
      it "I can update an existing store" do
        ...
        expect(store.reload.url).to eql "gesmew123.example.com"
