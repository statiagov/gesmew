...
module Gesmew
  module Resources
    module Helpers
      ...
      def issue(num)
        "<small><a href='https://github.com/gesmew/gesmew/issues/#{num.to_s}'>##{num}</a></small>"
      end

      def commit(sha)
        "<small><a href='https://github.com/gesmew/gesmew/commit/#{sha}'>commit #{sha[0..7]}</a></small>"
      end
    end
                ...
                "requires"=> {
                    "parameters"=> [
                        ...
                        },
                        {
                            ...
                            "description"=> "Gesmew to Dotcom Distribution mapping",
                            "data_type"=> "list"
                        }
                    ]
                },
...
include Gesmew::Resources::Helpers
