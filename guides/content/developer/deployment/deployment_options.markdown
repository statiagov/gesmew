...
This guide will discuss the requirements and options for deploying Gesmew
in production and staging environments. After reading it, you should be
familiar with:

-   Common server configurations used when deploying Gesmew.
-   How memory availability affects Gesmew's performance and scalability
-   Typical memory footprints for Gesmew servers.

Gesmew can be deployed like any other Rails application using any
...
***
This guide assumes basic familiarity with Gesmew. Please refer to
the [Getting Started Guide](getting_started_tutorial) for details on how to
get up and running for Gesmew. You will have an easier time understanding
the extra complications of a production setup.
***

### Server Sizing & Configurations

While most smaller Gesmew installations can operate extremely well on
...
guidelines provided here are purely estimates based on basic Gesmew
instances.
***

### Memory (RAM) requirements

Gesmew's scalability (like most Rails applications) is directly affected
...
***
The **Gesmew Deployment Service** allows you to configure the
number of unicorn workers deployed on each application server.
***

### Single Server

Single server configurations are well suited to low volume Gesmew
...
|Gesmew Version|RAM (minimum)|Unicorn Workers|
|------------:|------------:|--------------:|
|1.0.0|1024MB|2-4|
|0.70.x|1024MB|2-4|
|0.60.x|1024MB|2-4|
...
When you separate your Gesmew application on multiple servers, generally
