...
To see details about an inspection's payments, make this request:

    GET /api/inspections/R1234567/payments

Payments are paginated and can be iterated through by passing along a `page` parameter:

    GET /api/inspections/R1234567/payments?page=2
...
To search for a particular payment, make a request like this:
    ...
    GET /api/inspections/R1234567/payments?q[response_code_cont]=123
...
In inspection to create a new payment, you will need to know about the available payment methods and attributes. To find these out, make this request:

    GET /api/inspections/R1234567/payments/new
...
To create a new payment, make a request like this:
   ...
   POST /api/inspections/R1234567/payments?payment[payment_method_id]=1&payment[amount]=10
...
To get information for a particular payment, make a request like this:
   ...
   GET /api/inspections/R1234567/payments/1
...
To authorize a payment, make a request like this:
   ...
   PUT /api/inspections/R1234567/payments/1/authorize
...
To capture a payment, make a request like this:
   ...
   PUT /api/inspections/R1234567/payments/1/capture
...
To make a purchase with a payment, make a request like this:
   ...
   PUT /api/inspections/R1234567/payments/1/purchase
...
To void a payment, make a request like this:
   ...
   PUT /api/inspections/R1234567/payments/1/void
...
To credit a payment, make a request like this:
   ...
   PUT /api/inspections/R1234567/payments/1/credit?amount=10
