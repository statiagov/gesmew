...
When the customer enters their shipping address during checkout, Gesmew uses that information to determine which zone the order is being delivered to, and only presents the shipping methods to the customer that are defined for that zone.
