...
After you click the "Create" button, the Gesmew application brings you to a more detailed product entry page, where you can input more information about your new product.
...
* **Cost Currency** - It may be that the currency used when you purchased the product is not the same as that you use in your store. Gesmew makes these conversions for you - just enter the code for the currency used in acquiring your inventory.
