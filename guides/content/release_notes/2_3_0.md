...
*   Order#token is no longer fetched from another table.
    ...
    Order#token value is now persisted into gesmew_orders.guest_token. Main motivation
...
*   refactor the api to use a general importer in `lib/gesmew/importer/order.rb`
...
*   Increase the precision of the amount/price columns in order for support other currencies. See https://github.com/gesmew/gesmew/issues/4657
