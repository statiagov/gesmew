...
application had a *Product* class, then this would cause Gesmew's
...
*Gesmew::Product*, *Gesmew::Variant* and *Gesmew::ProductsController*.
...
officially retired. Please use *Gesmew::Product#price*,
*Gesmew::Product#price=*, *Gesmew::Product#has_variants?* and
*Gesmew::Product#master* respectively instead.
...
You will need to update your routes file in order for Gesmew's routes to
...
-   If your application defines any class decorators, you will need to
    ...
    means *Product* becomes *Gesmew::Product*, *Country* becomes
    *Gesmew::Country*, and so on.
-   Correct the paths to any templates you are overriding to include the
    Gesmew namespace. Things such as **app/views/products/show.html.erb**
    have now become **app/views/gesmew/products/show.html.erb**.
