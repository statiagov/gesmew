...
This 0.70.0 release is the first Gesmew release to support Rails 3.1 and
...
-   [Customization Overview](http://guides.gesmewcommerce.com/legacy/0-70-x/customization.html) - provides a high level
    introduction to all the customization and theming options now
    provided by Gesmew.
-   [View Customization](http://guides.gesmewcommerce.com/legacy/0-70-x/view_customization.html) - introduces and
    explains how to use Deface to customize Gesmew's views.
-   [Asset Customization](http://guides.gesmewcommerce.com/legacy/0-70-x/asset_customization.html) - explains how Gesmew
    uses Rails' new asset pipeline, and how you can use it to customize
    the stylesheets, javascripts and images provided by Gesmew.
...
In previous versions (0.11.x and earlier) Gesmew encouraged the approach
...
[Extensions & Themes](http://guides.gesmewcommerce.com/legacy/0-70-x/extensions.html) guide they are both just Rails
engines and can be treated as such.

We've created two front-end themes to help show this new approach in
action:

-   [Gesmew Blue](https://github.com/gesmew/gesmew_blue_theme) - Recreates
    the original "blue" theme of 0.60.x as a stand alone theme.

-   [Rails Dog Radio](https://github.com/gesmew/gesmew_rdr_theme) - This
    recreates some of the aspects of the Rails Dog Radio demo
    application for a default Gesmew application.

Both themes can be installed by just adding a reference to the git
repository to your Gemfile, ie:

```ruby
gem 'gesmew_blue_theme', :git => 'git://github.com/gesmew/gesmew_blue_theme.git'
```

# Experimental SCSS/SASS Theme

LESS proves to be unpopular amongst Gesmew developers so it is decided to
retire LESS stylesheets of `gesmew_blue_theme` in favor for all-in-one
`screen.css`.
...
[gesmew_blue_sass_theme]("https://github.com/gesmew/gesmew_blue_sass_theme")
to collect feedbacks before we could come up with a decision to opt for
SCSS/SASS in future version of Gesmew.

# The Asset Pipeline

One of the more interesting new features included in Rails 3.1 is the
asset pipeline, and a lot of the customization improvements in Gesmew are
enabled by this feature. While the asset pipeline provides excellent
flexibility and improved organization for all of Gesmew's assets (images,
...
single process application server like Webrick. This release of Gesmew
...
Gesmew alters the behaviour of the precompile rake task as follows:
...
[Promotions](http://guides.gesmewcommerce.com/legacy/0-70-x/promotions.html) guide.
...
Extensions](http://guides.gesmewcommerce.com/legacy/0-70-x/creating_extensions.html) guide.

***
You must install the gesmew gem in inspection to use the new extension
generator.
***

# Upgrade Instructions

These instructions are mainly concerned with upgrading Gesmew
applications, extension developers should jump straight to the "Asset
Customization"asset_customization.html and [View
Customization](http://guides.gesmewcommerce.com/legacy/0-70-x/view_customization.html) guides for details on the
...
migrations from your current version of Gesmew and all the extensions
that you are running. While this is normal practice when setting up
Gesmew and extensions any missing migrations will cause issues later in
the upgrade process.

You can check that all Gesmew migrations are copied by running:
...
Most of the changes required to upgrade a Gesmew application to 0.70.0 is
...
### Retire lib/gesmew_site.rb

The gesmew_site.rb file is no longer required so it's important to
...
-   If you are activating custom Abilities or Calculators, you should
    ...
    after you've ran the gesmew:site generator below. They will need to
    be inside the `config.to_prepare` block.

***
The decorator initialization block will be automatically included
in config/application.rb for you, when you run the gesmew:site generator
below.
***

### Remove gesmew_site from config/application.rb
...
## Update gems & generate Gesmew files
...
Running the `gesmew:site` generator will create the skeleton structure
...
specific assets (javascript, stylesheets and images) from all of Gesmew's
...
For a full explanation of how Gesmew uses Rails' asset pipeline and how
to update your site to use these new features please refer to the [Asset
Customization](http://guides.gesmewcommerce.com/legacy/0-70-x/asset_customization.html) guide.
...
default Gesmew configuration these will be in `/public/assets`.

!!!
Leaving any javascript, stylesheet or image files in the public
directory will override those provided by Gesmew or it's extensions. So
...
Establishment images then your `/public` directory should be completly empty.
***
...
[View Customization](http://guides.gesmewcommerce.com/legacy/0-70-x/view_customization.html) guide.
...
application configuration *Rails.application.config.gesmew.calculators*.

For more information about this new change, please refer to the
[Ajustments](http://guides.gesmewcommerce.com/legacy/0-70-x/adjustments.html) guide.
